...
.select-contents ul {vertical-align:middle; text-align:center;} 
...
.select-contents-btn {width:50px; height:50px;}
...
<div class="contents-box">
	<div class="contents">
		...
		<div class="select-contents">
			<ul>
				<li><img class="select-contents-btn" src="/resources/img/leftarrow.png" alt="" /></li>
				...
				<li><a href="#"><img src="/resources/img/test1.jpg" alt="test1" /></a></li>
				<li><a href="#"><img src="/resources/img/test2.jpg" alt="test2" /></a></li>
				<li><img class="select-contents-btn" src="/resources/img/rightarrow.png" alt="" /></li>
			</ul>
		</div>
	</div>
</div>
